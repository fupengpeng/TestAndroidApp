...
import com.fupengpeng.testandroidapp.mvp.model.GirlModelImplV2;
...
public class GirlPresenterV2 {
    ...
    //通过构造方法实例化mIGirlView
    public GirlPresenterV2(IGirlView mIGirlView) {
    ...
    public void setmGirlModel(int i){
        switch (i){
            case 1:
                mGirlModel = new GirlModelImplV2();//实例化model接口001  本地获取数据
                break;
            case 2:
                mGirlModel = new GirlModelImplV2();//实例化model接口002  获取网络数据
                break;
            default:
